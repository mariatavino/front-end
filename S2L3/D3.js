...
let tizio = starWarsCharacters[parseInt(Math.random()*10)];
console.log(tizio.name + " ha un'altezza di " + tizio.height + "cm, pesa " + tizio.mass + "kg, ha i capelli " + tizio.hair_color + " e gli occhi " + tizio.eye_color + ". Il suo anno di nascita è " + tizio.birth_year + ", la sua pelle ha una tonalità " + tizio.skin_color +  " ed è un/a " + tizio.gender);
